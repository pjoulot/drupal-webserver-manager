...
ansible-playbook -i inventory/webservers server.yml --extra-vars "server_ip=$SERVER_IP server_user=$SERVER_USER mysql_root_password=$MYSQL_ROOT_PASSWORD apache_port=$APACHE_PORT varnish_listen_port=$VARNISH_PORT"
